    ...
    public class WithdrawMoneyModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            var newTransaction = new TransactionsDataModel
            {
                ...
                Remarks = $"Rs.{Amount}/- has been debited from your Account No. XXXX{accNo.Substring(accNo.Length-4)} as a mode of online withdrawl on {DOT}. Your Current Balance is {closingBalance}"
            ...
            if (insertedTransaction != null || insertedTransaction.Id > 0)
            {
                ...
                if (result)
                {
                    SuccessMessage = $"Transaction Successful! Rs.{Amount} has been Debited from your account as a mode of online withdrawl. Your current Balance is {closingBalance}.";
                    return;
                }
            }
